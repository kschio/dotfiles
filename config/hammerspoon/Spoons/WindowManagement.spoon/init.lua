...
obj.subMash = { 'ctrl', 'alt' }

obj.mapping = {
  left = { obj.subMash, 'left' },
  right = { obj.subMash, 'right' },
  up = { obj.subMash, 'up' },
  down = { obj.subMash, 'down' },
  upleft = { obj.subMash, '1' },
  upright = { obj.subMash, '2' },
  botleft = { obj.subMash, '3' },
  botright = { obj.subMash, '4' },
  maximum = { obj.subMash, 'm' },
  toggleFullScreen = { obj.subMash, 'f' },
  toggleZoom = { obj.subMash, 'z' },
  center = { obj.subMash, 'c' },
  nextScreen = { obj.subMash, 'n' },
  previousScreen = { obj.subMash, 'p' },
  resizeOut = { obj.subMash, '=' },
  resizeIn = { obj.subMash, '-' }
}
